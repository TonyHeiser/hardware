...
export const elements = {
  ...
  actinium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Actinium is a soft, silvery-white radioactive metal. It glows faintly in the dark due to its intense radioactivity. Actinium is used primarily as a neutron source and in radiation therapy for cancer treatment. Additionally, it has potential applications in targeted alpha-particle cancer therapies.",
  },
  ...
  thorium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Thorium is a silvery-white metal that tarnishes when exposed to air, forming a grayish-black oxide coating. It is used in various applications, including as a nuclear fuel in thorium reactors and in the manufacturing of high-quality optics and glass. Additionally, thorium is used in gas mantles for portable gas lights and as an alloying element in magnesium to improve its strength and high-temperature performance.",
  },
  ...
  protactinium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Protactinium is a dense, silvery-gray metal that tarnishes slowly in air and is highly radioactive. Due to its scarcity and high radioactivity, protactinium has limited practical applications. It is mainly used for research purposes in the fields of chemistry and nuclear physics. Additionally, it helps scientists understand the properties of other actinides and their compounds.",
  },
  ...
  uranium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Uranium is a heavy, silvery-white metal that is weakly radioactive and tarnishes when exposed to air. It is primarily used as a fuel in nuclear power plants due to its ability to sustain nuclear chain reactions. Uranium is also used in military applications, such as in armor-piercing projectiles and nuclear weapons. Additionally, it has applications in the fields of radiometric dating and as a coloring agent in glass and ceramics.",
  },
  ...
  neptunium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Neptunium is a silvery radioactive metal that belongs to the actinide series of elements. It typically appears metallic and lustrous when freshly prepared, but quickly tarnishes in air, forming a thin oxide layer. Due to its radioactive nature, neptunium primarily finds applications in nuclear reactors and as a component in research involving nuclear fuels and materials. It plays a significant role in the study of nuclear chemistry and the development of nuclear technology.",
  },
  ...
  plutonium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Plutonium is a silvery-white metal that can appear with a slightly yellow tint when oxidized. It is primarily known for its use as a key material in nuclear weapons and nuclear reactors due to its ability to sustain nuclear fission chain reactions. Beyond military applications, plutonium is also utilized in certain types of spacecraft power systems (such as radioisotope thermoelectric generators) and in nuclear research for studying the behavior of nuclear materials. Due to its radioactive nature, strict handling and disposal protocols are essential to mitigate health and environmental risks associated with plutonium.",
  },
  ...
  americium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Americium is a silvery-white metal that tarnishes slowly in dry air, developing a dull gray appearance. It is primarily used in household smoke detectors, where its radioactive decay emits alpha particles that ionize the air inside the detector, triggering an alarm in the presence of smoke. Additionally, americium is employed in industrial gauges for thickness measurement of materials like paper and metal sheets, as well as in neutron sources for scientific research and industrial applications such as oil well logging. Its radioactive properties and stability make it valuable in these specialized technologies despite its relatively short half-life isotopes.",
  },
  ...
  curium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Curium is a silvery-white, radioactive metal that tarnishes slowly in moist air, resembling its neighboring actinides in appearance. It is primarily used in scientific research, particularly in the study of nuclear physics and chemistry. Curium isotopes are valuable as neutron sources for specialized instruments, such as portable neutron radiography devices used in industrial applications like pipeline inspection. Its production and use are tightly regulated due to its high radioactivity and potential health risks, necessitating strict safety protocols in handling and disposal.",
  },
  ...
  berkelium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Berkelium is a silvery-white, radioactive metal that tarnishes slowly in air, similar in appearance to other actinides. It is primarily used in scientific research, particularly in the study of nuclear reactions and the synthesis of heavier elements. Berkelium isotopes are valuable as neutron sources for specialized instruments used in nuclear physics experiments and as target materials for producing even heavier elements through nuclear transmutation. Due to its high radioactivity, berkelium requires stringent safety measures during handling and disposal to protect researchers and the environment.",
  },
  ...
  californium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Californium is a silvery-white, radioactive metal that tarnishes quickly in moist air, resembling other actinides in appearance. It is primarily utilized as a neutron source in various applications, such as in neutron moisture gauges for detecting water content in soil and in portable neutron sources for industrial radiography and oil well logging. Californium isotopes are also used in scientific research for nuclear physics experiments and in medicine for cancer treatment, particularly brachytherapy. Due to its high radioactivity, Californium is handled with strict safety measures to minimize exposure risks to personnel and the environment.",
  },
  ...
  einsteinium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Einsteinium is a synthetic, silvery-white, radioactive metal that tarnishes quickly in air due to oxidation. It is produced in minute quantities and primarily used for research purposes in nuclear physics and chemistry. Einsteinium isotopes are crucial in studying the behavior of heavy elements and in understanding nuclear reactions. Its intense radioactivity limits practical applications, but it is occasionally used as a radiation source in specialized scientific instruments and as a target material for creating even heavier elements through nuclear transmutation experiments. Due to its hazardous nature, strict safety measures are essential during handling and storage of einsteinium.",
  },
  ...
  fermium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Fermium is a synthetic, radioactive metal that appears silvery-white and tarnishes quickly in air. It is produced in very small quantities and is primarily used for research purposes in nuclear chemistry and physics. Fermium isotopes are valuable for studying nuclear reactions and the behavior of heavy elements, contributing to our understanding of fundamental nuclear processes. Due to its high radioactivity and short half-life, fermium has limited practical applications outside of scientific research, where it is handled under stringent safety protocols to minimize radiation exposure risks.",
  },
  ...
  mendelevium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Mendelevium is a synthetic, radioactive metal that appears silvery-white in its pure form. It is extremely rare and produced only in minute quantities for scientific research purposes, particularly in nuclear chemistry and physics. Mendelevium isotopes are valuable for studying nuclear reactions and the properties of heavy elements, aiding in the advancement of fundamental understanding in nuclear science. Due to its intense radioactivity and short half-life, mendelevium has no practical applications outside of scientific research and is handled under strict safety protocols to minimize radiation exposure risks.",
  },
  ...
  nobelium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Nobelium is a synthetic, radioactive metal that appears silvery-white in its pure form and tarnishes quickly in air. It is produced in extremely small quantities for scientific research purposes, particularly in the field of nuclear physics and chemistry. Nobelium isotopes are used primarily to study the properties of heavy elements and nuclear reactions due to their high radioactivity and short half-life. Its applications are confined to specialized experiments aimed at advancing our understanding of nuclear structure and behavior, and it requires careful handling and disposal protocols to mitigate radiation hazards",
  },
  ...
  lawrencium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Lawrencium is a synthetic, radioactive metal that is expected to have a silvery appearance, similar to other actinides. It is produced in extremely small quantities for scientific research purposes, particularly in nuclear physics and chemistry. Lawrencium isotopes are utilized primarily in experiments aimed at studying nuclear reactions and the properties of heavy elements, contributing to our understanding of nuclear structure and behavior. Due to its high radioactivity and short half-life, lawrencium has no practical applications outside of fundamental research and is handled under stringent safety protocols to minimize radiation exposure risks.",
  },
  ...
  rutherfordium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Rutherfordium is a synthetic, radioactive metal that is expected to have a silvery appearance, similar to other elements in the actinide series. It is produced in minute quantities through nuclear reactions and is primarily used for scientific research purposes, particularly in nuclear physics and chemistry. Rutherfordium isotopes are crucial in experiments aimed at studying nuclear fusion, heavy element synthesis, and understanding nuclear structure. Due to its high radioactivity and short half-life, Rutherfordium has no practical applications outside of scientific research and is handled with stringent safety protocols to minimize radiation exposure risks.",
  },
  ...
  dubnium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Dubnium is a synthetic, radioactive metal that is expected to have a silvery-white appearance, similar to other elements in the actinide series. It is produced in extremely small quantities through nuclear reactions and is primarily used for scientific research purposes, particularly in nuclear physics and chemistry. Dubnium isotopes are essential in experiments aimed at understanding nuclear reactions, heavy element synthesis, and the behavior of superheavy elements. Due to its high radioactivity and short half-life, dubnium has no practical applications outside of fundamental research and is handled under stringent safety protocols to minimize radiation exposure risks.",
  },
  ...
  seaborgium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Seaborgium is a synthetic, radioactive metal that is expected to have a silvery-white appearance, similar to other elements in the actinide series. It is produced in minute quantities through nuclear reactions and is primarily used for scientific research, particularly in nuclear physics and chemistry. Seaborgium isotopes are crucial in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and probing the properties of superheavy elements. Due to its high radioactivity and short half-life, seaborgium has no practical applications outside of fundamental research and is handled under stringent safety protocols to minimize radiation exposure risks.",
  },
  ...
  bohrium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Bohrium is a synthetic, radioactive metal that is predicted to have a silvery-white appearance, similar to other elements in the actinide series. It is produced in extremely small quantities through nuclear reactions and is primarily utilized for scientific research, particularly in the fields of nuclear physics and chemistry. Bohrium isotopes are essential in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and exploring the properties of superheavy nuclei. Due to its high radioactivity and short half-life, Bohrium has no practical applications beyond fundamental scientific research and is handled with strict safety protocols to minimize radiation exposure risks.",
  },
  ...
  hassium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Hassium is a synthetic, radioactive element that is expected to have a metallic appearance, possibly silvery-white like other elements in its group. It is produced in minute quantities through nuclear reactions and is primarily used for scientific research, particularly in nuclear physics and chemistry. Hassium isotopes are crucial in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and probing the properties of superheavy nuclei. Due to its high radioactivity and short half-life, hassium has no practical applications outside of fundamental scientific research and is handled under strict safety measures to mitigate radiation exposure risks",
  },
  ...
  meitnerium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Meitnerium is a synthetic, radioactive metal that is predicted to have a metallic appearance, potentially silvery-white in color like other elements in its group. It is produced in minuscule amounts through nuclear reactions and is exclusively used for scientific research, particularly in the fields of nuclear physics and chemistry. Meitnerium isotopes play a critical role in experiments focused on studying nuclear reactions, synthesizing heavy elements, and investigating the properties of superheavy nuclei. Due to its extreme radioactivity and short half-life, meitnerium has no practical applications outside of fundamental scientific research and is handled under stringent safety measures to protect researchers and the environment from radiation exposure.",
  },
  ...
  darmstadtium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Darmstadtium is a synthetic, radioactive element that is expected to have a metallic appearance, possibly silvery-white in color like other elements in its group. It is produced in very small quantities through nuclear reactions and is exclusively used for scientific research, particularly in the fields of nuclear physics and chemistry. Darmstadtium isotopes are crucial in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and exploring the properties of superheavy nuclei. Due to its extreme radioactivity and short half-life, darmstadtium has no practical applications outside of fundamental scientific research and is handled under strict safety protocols to mitigate radiation exposure risks.",
  },
  ...
  roentgenium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Roentgenium is a synthetic, radioactive metal that is expected to have a metallic appearance, possibly silvery-white in color like other elements in its group. It is produced in extremely small quantities through nuclear reactions and is exclusively used for scientific research, particularly in nuclear physics and chemistry. Roentgenium isotopes play a crucial role in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and investigating the properties of superheavy nuclei. Due to its high radioactivity and short half-life, roentgenium has no practical applications outside of fundamental scientific research and is handled with strict safety protocols to mitigate radiation exposure risks.",
  },
  ...
  copernicium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Copernicium is a synthetic, radioactive element that is expected to have a metallic appearance, likely silvery-white in color similar to other elements in its group. It is produced in extremely small quantities through nuclear reactions and is exclusively used for scientific research, particularly in nuclear physics and chemistry. Copernicium isotopes are crucial in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and probing the properties of superheavy nuclei. Due to its high radioactivity and short half-life, Copernicium has no practical applications outside of fundamental scientific research and is handled with strict safety protocols to minimize radiation exposure risks.",
  },
  ...
  nihonium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Nihonium is a synthetic, radioactive element that is expected to have a metallic appearance, potentially silvery-white like other elements in its group. It is produced in very small quantities through nuclear reactions and is exclusively used for scientific research, particularly in the fields of nuclear physics and chemistry. Nihonium isotopes play a crucial role in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and investigating the properties of superheavy nuclei. Due to its high radioactivity and short half-life, nihonium has no practical applications outside of fundamental scientific research and is handled with strict safety protocols to mitigate radiation exposure risks.",
  },
  ...
  flerovium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Flerovium is a synthetic, radioactive metal that is expected to have a metallic appearance, possibly silvery-white like other elements in its group. It is produced in very small quantities through nuclear reactions and is exclusively used for scientific research, particularly in nuclear physics and chemistry. Flerovium isotopes play a critical role in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and probing the properties of superheavy nuclei. Due to its high radioactivity and short half-life, flerovium has no practical applications beyond fundamental scientific research and is handled under strict safety protocols to minimize radiation exposure risks.",
  },
  ...
  moscovium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Moscovium is a synthetic, radioactive element that is predicted to have a metallic appearance, potentially silvery-white like other elements in its group. It is produced in extremely small quantities through nuclear reactions and is used exclusively for scientific research, particularly in nuclear physics and chemistry. Moscovium isotopes are crucial in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and investigating the properties of superheavy nuclei. Due to its high radioactivity and short half-life, moscovium has no practical applications beyond fundamental scientific research and is handled with strict safety protocols to minimize radiation exposure risks.",
  },
  ...
  livermorium: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Livermorium is a synthetic, radioactive element that is expected to have a metallic appearance, possibly silvery-white like other elements in its group. It is produced in very small quantities through nuclear reactions and is exclusively used for scientific research, particularly in nuclear physics and chemistry. Livermorium isotopes are crucial in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and exploring the properties of superheavy nuclei. Due to its high radioactivity and short half-life, livermorium has no practical applications beyond fundamental scientific research and is handled with strict safety protocols to minimize radiation exposure risks.",
  },

  tennessine: {
    latinName: "Tennessium",
    char: "Ts",
    number: 117,
    atomicMass: 294.2,
    electronegativity: null,
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Tennessine is a synthetic, highly radioactive element that is predicted to have a metallic appearance, potentially silvery-white in color like other elements in its group. It is produced in extremely small quantities through nuclear reactions and is exclusively used for scientific research, particularly in nuclear physics and chemistry. Tennessine isotopes are crucial in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and exploring the properties of superheavy nuclei. Due to its high radioactivity and short half-life, tennessine has no practical applications beyond fundamental scientific research and is handled with strict safety protocols to minimize radiation exposure risks.",
  },
  ...
  oganesson: {
    ...
    boilingPointC: 0,
    boilingPointF: 0,
    info: "Oganesson is a synthetic, highly radioactive element that is predicted to have a metallic appearance, potentially silvery-white in color like other elements in its group. It is produced in minuscule quantities through nuclear reactions and is exclusively utilized for scientific research, particularly in nuclear physics and chemistry. Oganesson isotopes are critical in experiments aimed at studying nuclear reactions, synthesizing heavy elements, and investigating the properties of superheavy nuclei. Due to its extreme radioactivity and short half-life, oganesson has no practical applications outside of fundamental scientific research and is handled with strict safety protocols to mitigate radiation exposure risks.",
  },
